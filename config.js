...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~YVJRxQRb#DAEPWickMTfOZj0vO0pCr8xPAp4CXCdJVVeaPBLRVq8",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY Official OnePesewa 🤍*",
...
BOT_NAME: process.env.BOT_NAME || "OP-BOT",
// add bot name here for menu
STICKER_NAME: process.env.STICKER_NAME || "OP TECH",
...
// image for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> *OP-MD*⚡",
// alive msg content
...
DEV: process.env.DEV || "233544482494",
